...
public class WarehouseTest {
    ...
    @Test
    public void testAddMaterialThrowsException() {
        ...
        assertThrows(AddMaterialException.class, () -> {
            warehouse1.addMaterial(materialOverCapacity);
        });
    }
    ...
    @Test
    public void testTransferMaterial() throws TransferException, AddMaterialException {
        Material material3 = new Material("Copper", "A conductive metal", "copper_icon.png", 100);
        material3.setQuantity(60);
        warehouse1.addMaterial(material3);

        warehouse1.transferMaterial("Copper", 60, warehouse2);
        ...
        warehouse1.addMaterial(material4);

        warehouse1.transferMaterial("Copper", 40, warehouse2);
        assertNull(warehouse1.getMaterials().get("Copper"));
        assertEquals(100, warehouse2.getMaterials().get("Copper").getQuantity());
    }

    @Test
    public void testTransferMaterialThrowsExceptionWhenRequestingTransferOfNonExistingMaterial() {
        assertThrows(TransferException.class, () -> {
            warehouse1.transferMaterial("Copper", 200, warehouse2);
        });
    }
    ...
    public void testTransferMaterialThrowsTransferException() throws AddMaterialException {
        ...
        warehouse2.addMaterial(materialInWarehouse2);
        warehouse1.outputMaterials();
        warehouse2.outputMaterials();

        TransferException exception = assertThrows(TransferException.class, () -> {
            warehouse1.transferMaterial("Copper", 20, warehouse2);
        });
